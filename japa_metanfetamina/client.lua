    ...
    while true do
        ...
        local dist = GetDistanceBetweenCoords(GetEntityCoords(ped),blipcomponentes[1],blipcomponentes[2],blipcomponentes[3], true )        
            if dist <= 15 and not componentes and etapa == 0 then           
                DrawMarker(21,blipcomponentes[1],blipcomponentes[2],blipcomponentes[3]-0.6,0,0,0,0.0,0,0,0.5,0.5,0.4,255,0,0,50,0,0,0,1)
                if dist <= 0.6 then 
                    msg ("PRESSIONE  ~b~E~w~  PARA PEGAR OS COMPONENTES",4,0.5,0.93,0.50,255,255,255,180)
